...
socket.send_string('{"question": "What is the  shortest path through my workplace, a gym and a supermarket from my home in Amsterdam","placename":["Amsterdam"],"replaceQ": "What is the  shortest path through my workplace, a gym and a supermarket from my home extent"}')
