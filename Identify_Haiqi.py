    ...
    for tt in TypeDict['tag']:
        if (tt == 'boolfield' and 'serviceobj' not in TypeDict['tag']) or tt == 'allocation' or tt == 'conAm':
            ...
            if n_in - 1 >= 0 and TypeDict['tag'][n_in - 1] == 'destination':
                if n_in - 2 >= 0 and TypeDict['tag'][
                    n_in - 2] == 'origin':  # ['origin', 'destination', 'networkC'] //'roadData',
                    if len(TypeDict['id'][
                               n_in - 2]) == 2:  # [['grid', 'centroid'], 'destination', 'networkC'] //'roadData'
