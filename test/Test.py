...
doOOParserTest("blocklyoutput_retri.json", "retri_parser_results_0620.json", "retri_parser_results_test.json")
print("============================== TESTING GeoAnQu dataset")
doOOParserTest("blocklyoutput_GeoAnQu.json", "GeoAnQu_parser_results_0620.json", "geoanqu_parser_results_test.json")
print("============================== TESTING MS student dataset")
doOOParserTest("blocklyoutput_Leticia.json", "Leticia_parser_results_0620.json", "student_parser_results_test.json")
...
def testRuleGeneration():
    ...
    corpora = {"GeoAnQu_parser_results_0620.json": "GeoAnQu_parser_results_0620_annotatedCCT.json",
               "retri_parser_results_0620.json": "retri_parser_results_0620_annotatedCCT.json",
                "Leticia_parser_results_0620.json": "Leticia_parser_results_0620_annotatedCCT.json"}
    ...
    for corpusFileName in corpora.keys():
        ...
        for qJson in qJsonArray:
            # tqConv.algebraToQuery(qJson, validate=True, annotate=True)
